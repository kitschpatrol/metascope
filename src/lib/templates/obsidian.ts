...
export const obsidian = defineTemplate(
	(
		...
		'Latest Release Date':
			github.releaseDateLatest ?? npm.publishDateLatest ?? pypi.publishDateLatest ?? null,
		...
		// ── Stats ──────────────────────────────────────────
		Releases: github.releaseCount ?? null,

		// ── Activity ──────────────────────────────────────────
		'Open Issues ': github.issueCountOpen ?? null,
		'Closed Issues': github.issueCountClosed ?? null,
		'Open PRs ': github.pullRequestCountOpen ?? null,
		'Merged PRs': github.pullRequestCountMerged ?? null,
		'Closed PRs': github.pullRequestCountClosed ?? null,
		Alerts: github.vulnerabilityAlertCount ?? null,
		...
		Dependencies: codemeta.softwareRequirements?.length ?? null,
		'Dev Dependencies': codemeta.softwareSuggestions?.length ?? null,
		'Major Updates': updates.major?.length ?? null,
		'Minor Updates': updates.minor?.length ?? null,
		'Patch Updates': updates.patch?.length ?? null,
		'Total Updates': updates.total ?? null,
		Libyears: updates.libyears ?? null,
		...
		'Commits Ahead of Fork': github.commitsAheadUpstream ?? null,
		'Commits Behind Fork': github.commitsBehindUpstream ?? null,
		'Commits Ahead of Total': git.totalAhead ?? null,
		'Commits Behind Total': git.totalBehind ?? null,
		'Git LFS': github.hasLfs ?? null,
		'Git Clean': git.isClean ?? null,
		'Git Tags': git.tagCount ?? null,
		'Git Branch': git.branchCurrent ?? null,
		'Git Branches': git.branchCount ?? null,
		'Git Remotes': git.remoteCount ?? null,
		'Git Submodules': github.submoduleCount ?? null,
