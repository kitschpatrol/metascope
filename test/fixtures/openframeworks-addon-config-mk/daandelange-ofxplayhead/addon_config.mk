...
meta:
	ADDON_NAME = ofxPlayhead
	ADDON_DESCRIPTION = ofxPlayHead is ofGetElapsedTime() on steroids !
	ADDON_AUTHOR = @daandelange
	ADDON_TAGS = "utils" "clock" "timeline" "metronom" "sequencer" "player"
	ADDON_URL = http://github.com/daandelange/ofxPlayhead
