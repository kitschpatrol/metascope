...
meta:
	ADDON_NAME = ofxMTlibrealsense
	ADDON_DESCRIPTION = Packages the Intel RealSense SDK for simple inclusion into OF projects
	ADDON_AUTHOR = Cristobal Mendoza
	ADDON_TAGS = "Video/Camera" "RealSense" "computer vision"
	ADDON_URL = http://github.com/c-mendoza/ofxMTlibrealsense
...
common:
	...
	ADDON_INCLUDES = libs/librealsense2/include
...
linux64:
	...
	ADDON_LIBS =
	ADDON_LIBS += libs/librealsense2/lib/linux64/librealsense2.a
	ADDON_LIBS += libs/librealsense2/lib/linux64/librealsense2-gl.a
	ADDON_LIBS += libs/librealsense2/lib/linux64/librealsense-file.a
# vs:
