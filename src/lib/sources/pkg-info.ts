...
import type { PkgInfoData } from '../parsers/pkg-info-parser'
import type { MetadataSource, SourceContext } from './source'
import { log } from '../log'
import { parsePkgInfo } from '../parsers/pkg-info-parser'

export type PkgInfoSourceData = Partial<PkgInfoData>
...
export const pkgInfoSource: MetadataSource<'pkgInfo'> = {
	async extract(context: SourceContext): Promise<PkgInfoSourceData> {
