...
import type { SetupCfgData } from '../parsers/setup-cfg-parser'
import type { MetadataSource, SourceContext } from './source'
import { log } from '../log'
import { parseSetupCfg } from '../parsers/setup-cfg-parser'

export type SetupCfgSourceData = Partial<SetupCfgData>
...
export const setupCfgSource: MetadataSource<'setupCfg'> = {
	async extract(context: SourceContext): Promise<SetupCfgSourceData> {
